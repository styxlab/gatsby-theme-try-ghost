...
module.exports = ({ htmlAst }, pluginOptions) => {
    ...
    visit(htmlAst, { tagName: `pre` }, (parent) => {
        visit(parent, { tagName: `code` }, (node) => {
            // Do not visit added codeHtml again
            ...
            const codeHtml = ``
            + `<div class="${customClassName} ${highlightClassName}" class=" data-language="${languageName}">`
            ...
            visit(codeAST, { tagName: `div` }, (element) => {
                ...
                // Mark the pre element of the new codeHtml
    ...
    if (!noInlineHighlight) {
        visit(htmlAst, { tagName: `code` }, (node) => {
            let languageName = `text`
