...
This plugin also creates a `tableOfContents` field comprising of a tree structure. The table of contents is generated by analyzing all headlines from level one to six withing the given HTML blob.
