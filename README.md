...
| [`gatsby-rehype-ghost-images`](https://github.com/styxlab/gatsby-theme-try-ghost/tree/master/packages/gatsby-rehype-ghost-images) | [![version](https://badgen.net/npm/v/gatsby-rehype-ghost-images)](https://www.npmjs.com/package/gatsby-rehype-ghost-images) | Rewrite CMS Image links from absolute to relative |
